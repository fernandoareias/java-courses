package com.fernando.spring_security_jwt.configurations;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                .csrf(csrf -> csrf.disable())  // Desabilita CSRF (opcional para o H2 Console)
                ...
                .headers(headers -> headers.frameOptions().disable())  // Desabilita proteção de frames para o H2
